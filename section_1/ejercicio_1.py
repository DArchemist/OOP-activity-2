class Employee:
    ...
    def print_employees_info(self) -> None:
        print(f"EL CÓDIGO DEL EMPLEADO ES: {self.employees_code}, EL NOMBRE DEL EMPLEADO ES: {self.employees_name}, EL SALARIO BRUTO ES: ${self.gross_salary:.2f}, EL SALARIO NETO ES: ${self.net_salary:.2f}")


# To test the code, do

if __name__ == '__main__':
    Employee(1234, "Darley Ortiz", 48, 5000, 12.5).compute_salary_info().print_employees_info()